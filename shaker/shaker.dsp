...
shaker_sound(0,n) = so.loop(soundfile("Shaker X [url:{'Shakerxy_percutom_25bpm.wav'; 'Shakerxy_glupsdrum_50bpm.wav'; 'Shakerxy_808 _kicksnare_100bpm.wav'}]", 1), n);
shaker_sound(1,n) = so.loop(soundfile("Shaker Y [url:{'Shakerxy_triangle_25bpm.wav'; 'Shakerxy_springmetal_50bpm.wav'; 'Shakerxy_808_hh_100bpm.wav'}]", 1), n);
